...
export default function OverlayDescription({ activity }: OverlayDescriptionProps) {
  ...
  return (
    <div className="flex flex-col gap-[6px] md:gap-5 absolute left-5 bottom-6 md:bottom-[30px] z-20">
      ...
      <div>
        <h3 className="text-2lg-bold">{title}</h3>
      </div>
      <div className="flex gap-[5px]">
        <span className="text-lg-bold text-white">₩ {price}</span>
