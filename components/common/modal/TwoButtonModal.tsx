...
export default function TwoButtonModal({
  ...
  onConfirm,
  onCancel,
  containerClassName = 'w-[298px] p-[24px] bg-white rounded-lg shadow-lg',
}: ModalProps) {
  ...
  return (
    <div className={`relative ${containerClassName}`}>
      ...
      <div className="mt-[40px] mb-[32px] flex justify-center items-center">
        <p className="max-h-[62px] text-2lg-regular text-nomad-black overflow-auto text-center">{content}</p>
      </div>
