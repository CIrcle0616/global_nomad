...
export default function GNB() {
  ...
  return (
    <header className="w-full px-2 border-b py-[10px]">
      <div className="mx-auto flex justify-between items-center pl-4 sm:px-6 lg:px-[110px] max-w-[1440px]">
        ...
        {/* 알림 버튼 */}
        {user ? (
          <div className="flex items-center mt-2  gap-1 sm:gap-2 ml-auto">
            <AlarmButton />
            <ProfileButton />
          </div>
        ) : (
